...
CUDA_VISIBLE_DEVICES=3 python -W ignore ./tools/train.py --work_dir=$PP_WORK_DIR --local_rank=0 ./examples/point_pillars/configs/lvx_pedestrian_point_pillars.py 